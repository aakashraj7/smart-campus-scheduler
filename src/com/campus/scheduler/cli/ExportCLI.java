...
public class ExportCLI {
    ...
    private void exportTxt(Scanner scanner) {
        ...
        System.out.print("Enter Class ID to export (e.g. CSE-3A): ");
        ...
        try {
            ...
            System.out.println("✅ Class Timetable exported successfully to TXT file: " + path);
        } catch (Exception e) {
            System.out.println("❌ Error exporting TXT file: " + e.getMessage());
        }
    }
    ...
    private void exportCsv(Scanner scanner) {
        ...
        try {
            ...
            System.out.println("✅ Class Timetable exported successfully to CSV file: " + path);
        } catch (Exception e) {
    ...
    private void viewWorkloadAnalytics() {
        ...
        if (faculties.isEmpty()) {
            System.out.println("ℹ️ No faculties found in Database.");
            return;
        }
