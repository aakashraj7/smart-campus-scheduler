...
public class AuthCLI {
    ...
    public boolean checkInitialAdminSetup(Scanner scanner) {
        if (userDao.countUsers() == 0) {
            ...
            System.out.println("|    No admin account found. Let's create an Administrator account!  |");
            System.out.println("+-------------------------------------------------------------------+");
            ...
            while (true) {
                ...
                System.out.println("[ERROR] Invalid Username. Must be 2-20 alphanumeric characters without spaces.");
            }
            ...
            System.out.println("\n[OK] Administrator account '" + username + "' created successfully!");
    ...
    public boolean login(Scanner scanner) {
        ...
        if (user == null) {
            System.out.println("[ERROR] Invalid credentials: User not found.");
            return false;
        }

        if (PasswordUtil.verifyPassword(password, user.getPasswordHash())) {
            this.currentUser = user;
            System.out.println("\n[OK] Login Successful! Welcome " + user.getName() + " [" + user.getRole() + "]");
            return true;
        } else {
            System.out.println("[ERROR] Invalid credentials: Password incorrect.");
            return false;
        }
    }
    ...
    public void registerFacultyUser(Scanner scanner) {
        ...
        while (true) {
            ...
            if (!ValidationUtil.isValidCode(username)) {
                System.out.println("[ERROR] Invalid Username format. Use 2-20 alphanumeric characters.");
                continue;
            }
            if (userDao.findByUsername(username) != null) {
                System.out.println("[ERROR] Error: Username already exists.");
                continue;
            }
            break;
        }
        ...
        while (true) {
            ...
            if (facultyDao.findByFacultyId(facultyId) != null) {
                System.out.println("[ERROR] Error: Faculty ID already exists in Database.");
                continue;
            }
            break;
        }
        ...
        while (true) {
            ...
            System.out.println("[ERROR] Invalid Email Address format! Example: dr.smith@campus.edu");
        }
        ...
        while (true) {
            ...
            System.out.println("[ERROR] Invalid Mobile Number! Standard 10-digit number starting with 6, 7, 8, or 9 is required.");
        }
        ...
        while (true) {
            ...
            System.out.println("[ERROR] Invalid input! Must be a number between 1 and 8.");
        }
        ...
        while (true) {
            ...
            System.out.println("[ERROR] Invalid input! Must be a number between 1 and 40.");
        }
        ...
        System.out.println("\n+-------------------------------------------------------------------+");
        System.out.println("| [OK] SUCCESS! Faculty Account & Profile Created in 1 Unified Step |");
        System.out.println("+-------------------------------------------------------------------+");
    ...
    public void logout() {
        if (currentUser != null) {
            System.out.println("\n[INFO] Logged out user: " + currentUser.getUsername());
            currentUser = null;
        }
    }
}
